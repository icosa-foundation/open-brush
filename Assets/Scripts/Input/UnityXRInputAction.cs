        ...
        public struct BrushActions
        {
            ...
            public void SetCallbacks(IBrushActions instance)
            {
                if (m_Wrapper.m_BrushActionsCallbackInterface != null)
                {
                    ...
                    @ThumbTouch.started -= m_Wrapper.m_BrushActionsCallbackInterface.OnThumbTouch;
                    @ThumbTouch.performed -= m_Wrapper.m_BrushActionsCallbackInterface.OnThumbTouch;
                    @ThumbTouch.canceled -= m_Wrapper.m_BrushActionsCallbackInterface.OnThumbTouch;
                    @ThumbButton.started -= m_Wrapper.m_BrushActionsCallbackInterface.OnThumbButton;
                    @ThumbButton.performed -= m_Wrapper.m_BrushActionsCallbackInterface.OnThumbButton;
                    @ThumbButton.canceled -= m_Wrapper.m_BrushActionsCallbackInterface.OnThumbButton;
        ...
        public struct WandActions
        {
            ...
            public void SetCallbacks(IWandActions instance)
            {
                if (m_Wrapper.m_WandActionsCallbackInterface != null)
                {
                    ...
                    @ThumbTouch.started -= m_Wrapper.m_WandActionsCallbackInterface.OnThumbTouch;
                    @ThumbTouch.performed -= m_Wrapper.m_WandActionsCallbackInterface.OnThumbTouch;
                    @ThumbTouch.canceled -= m_Wrapper.m_WandActionsCallbackInterface.OnThumbTouch;
                    @ThumbButton.started -= m_Wrapper.m_WandActionsCallbackInterface.OnThumbButton;
                    @ThumbButton.performed -= m_Wrapper.m_WandActionsCallbackInterface.OnThumbButton;
                    @ThumbButton.canceled -= m_Wrapper.m_WandActionsCallbackInterface.OnThumbButton;
