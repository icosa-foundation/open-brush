...
namespace TiltBrush
{
    ...
    class ProfileButton : OptionButton
    {
        ...
        public string LoggedInText => m_LocalizedLoggedInText.GetLocalizedStringAsync().Result;

        public string LogInText => m_LocalizedLogInText.GetLocalizedStringAsync().Result;
