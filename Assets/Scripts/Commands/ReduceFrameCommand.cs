...
namespace TiltBrush.FrameAnimation
{
    public class ReduceFrameCommand : BaseCommand
    {
        ...
        public override bool IsAvailable => m_TimelineLocation.Item1 >= 0 &&
            ...
            m_Manager.GetFrameLength(m_TimelineLocation.Item1, m_TimelineLocation.Item2) > 1;

        protected override void OnRedo()
        {
            m_Operation = m_Manager.ReduceKeyFrame(m_TimelineLocation.Item1, m_TimelineLocation.Item2);
