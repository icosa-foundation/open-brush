...
namespace TiltBrush
{
    ...
    public static partial class ApiMethods
    {
        ...
        {
            location = App.ResolveMediaPath(App.GetAllImageRoots(), location);
        ...
        public static VideoWidget ImportVideo(string location)
        {
            ...
            location = App.ResolveMediaPath(App.GetAllVideoRoots(), location);
        ...
        [ApiEndpoint(
            "image.base64Decode",
            "Saves an image based on a base64 encoded string to an absolute path or filename. Relative paths are saved to the default image root directory."
        )]
        public static string SaveBase64(string base64, string filename)
        {
            ...
            var path = App.ResolveMediaPath(App.GetAllImageRoots(), filename);
