...
Shader "Custom/StandardSurfWithVertexColorEdgedNormals"
{
    Properties
    {
        ...
        _BumpStrength("Bump Strength", Range(-2, 2)) = 0
    ...
    SubShader
    {
        Pass
        {
            ...
            float4 frag(v2f i) : SV_TARGET
            {
                ...
                normal.z += calcEdges(i.uv1, i.uv2) * _BumpStrength;
                ...
                return float4(lighting * i.vertexColor.rgb, i.vertexColor.a);
            }
            ENDCG
        }
