...
8. Next priorities: action 3 model identity compatibility (read-only subagent investigation in progress) and action 4 async model recovery. Action 11 also needs network-pointer recognition checked for uppercase .TXT; discovery matching alone does not establish decoding parity. Release gate 12 remains open.
