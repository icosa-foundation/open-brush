...
| 9 | P2 | Repair remaining restoration side effects | Resolved images do not enter another folder's panel list; normalized missing-model recovery clears the correct pending entry after success | Model pending-entry cleanup included in action 4; image panel-list correction pending |
